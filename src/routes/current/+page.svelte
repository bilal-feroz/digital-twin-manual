<script>
  ...
  // ƒo. CALIBRATION: where BLUE should sit on ORANGE at "home"
  ...
  // ƒo. CALIBRATION: where RED sits inside BLUE at "home"
...
<div class="scene">
  ...
  <!-- Controls -->
  <div class="controls">
    <button on:click={up}>ƒ-ý</button>
    <div class="row">
      <button on:click={left}>ƒ-?</button>
      <button class="reset" on:click={reset}>Reset</button>
      <button on:click={right}>ƒ-ô</button>
    </div>
    <button on:click={down}>ƒ-¬</button>
  </div>
</div>
